                        ...
                        <div class="col-lg-8 col-md-8">
                                ...
                                <div class="row inside-hov-img">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="categories__post__item__text">
                                            ...
                                            <h3><a style="padding: 0px !important; margin: 10px 0px 10px 0px;" href="#">The Best Weeknight Baked Potatoes, 3 Creative Ways</a></h3>
                            ...
                            <div class="categories__list__post__item">
                                <div class="row inside-hov-img">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="categories__post__item__text">
                                            <span style="font-size: 40px ; " class="post__label">ASUS</span>
                                            <h3><a style="padding: 0px !important; margin: 10px 0px 10px 0px;" href="#">The Best Weeknight Baked Potatoes, 3 Creative Ways</a></h3>
                                            <ul class="post__widget">
                                                <li>by <span>Admin</span></li>
                                                <li>3 min read</li>
                           ...
                           <div class="categories__list__post__item">
                                <div class="row  inside-hov-img">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="categories__post__item__text">
                                            <span style="font-size: 40px ; " class="post__label">DELL</span>
                                            <h3><a style="padding: 0px !important; margin: 10px 0px 10px 0px;" href="#">The Best Weeknight Baked Potatoes, 3 Creative Ways</a></h3>
                                            <ul class="post__widget">
                                                <li>by <span>Admin</span></li>
                                                <li>3 min read</li>
