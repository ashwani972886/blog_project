...
<div class="row">
  <div class="col-md-4">
    <div class="card" style="overflow-y: scroll; height: 600px; padding: 10px;">

      <div  class="card" onclick="displayNewOrder( );">
        <div class="custom_card_header">
          <h6 style="float:right"> </h6>
          <!-- <h6><b>Order Id: </b></h6> -->
          <h6><b>Post Name / ID : Best phone in market </b></h6>
          <hr>
        </div>
        <div class="custom_card_body_order">
          <h5><b>POST NAME OR SUB NAME </b></h5>
          <hr>
        </div>
      </div>
      ...
      <div style="padding: 10px;" class="card" onclick="displayNewOrder( );">
        <div class="custom_card_header">
          <h6 style="float:right"> </h6>
          <!-- <h6><b>Order Id: </b></h6> -->
          <h6><b>Post Name / ID : Best phone in market </b></h6>
  ...
  <!-- <div class="col-md-8">
        <div class="card" style="overflow-y: scroll; height: 420px;">
          <div class="col-md-11 d-flex align-items-center" style="margin:auto; width: 100%; margin-top: 10px;">
            <div class="card" id="order_view" style="width: 100%;">
              <div class="text-center">
                <i class="far fa-hand-point-left" style="font-size: 50px;"></i>
  ...
  <div class="col-md-8">
    <div class="card" style="overflow-y: scroll; height: 600px;">
      <div class="col-md-11 d-flex align-items-center" style="margin:auto; width: 100%; margin-top: 10px;">
        <div  class="card" id="order_view" style="width: 100%;">
          ...
          <div style="padding: 10px; border: 2px solid red; width: 100%;">

            <div class="custom_card_header text-center">
              <h6 style="float:right"> </h6>
              <h5><b>Post Id / name: post name</b></h5>
            ...
            <div class="custom_card_body_order">
              ...
              <div style="padding: 10px;">
                <h5> <b><i> details name <span style="float: right;">numbers</span> </i></b></h5>

                <hr>
                <div>
                  <h6 style="margin-bottom: 20px;">Total likes <span style="float:right;">
                      <h5><b>111</b></h5>
                    </span></h6>
                  <h6 style="margin-bottom: 20px;"> total comments <span style="float:right;">
                      <h5><b>111</b></h5>
                    </span></h6>
                  <h6 style="margin-bottom: 20px;">total shares: <span style="float:right;">
                      <h5><b>111</b></h5>
                    </span></h6>
    ...
    <!-- ---------------------------------------------- next div ------------------------- -->
    <!-- 
<div style="padding: 20px 50px 20px 50px; border: 2px solid red;">
